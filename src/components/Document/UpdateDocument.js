...
class UpdateDocument extends Component {
    ...
    onSubmit(e){
        ...
        // console.log(updateocument);
        this.props.addDocument(updateocument, this.props.history);
    }

    componentDidMount() {
        const { document_id } = this.props.match.params;
        this.props.getDocument(document_id);
...
export default connect(mapStateToProps, { addDocument, getDocument, getClients, getDocumentTypes }) (UpdateDocument);
