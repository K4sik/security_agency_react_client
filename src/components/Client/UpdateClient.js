...
import { addClient, getClient } from "../../actions/clientAction";
...
class UpdateClient extends Component {
    ...
    onSubmit(e){
        ...
        this.props.addClient(updateClient, this.props.history);
    }
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-8 m-auto">
                            ...
                            <h4 className="display-4 text-center">Update Client</h4>
...
export default connect(mapStateToProps, { getClient, addClient, getClientTypes }) (UpdateClient);
